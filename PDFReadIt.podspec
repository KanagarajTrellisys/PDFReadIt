#
#  Be sure to run `pod spec lint BookReader.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Dmitry Zawadsky" => "dimazava@hotmail.com" }
  # Or just: spec.author    = "Dmitry Zawadsky"
  # spec.authors            = { "Dmitry Zawadsky" => "d.zawadsky@linksderisar.com" }
  # spec.social_media_url   = "https://twitter.com/Dmitry Zawadsky"
